...
- 評価データ(学習に必須)
  - <span class="red-char">ユーザID - アイテムID - 評価値</span> の形式 |
...
- 学習に必要なのは「誰がどの商品を<br><span class="red-char">星いくつと評価</span>した」というデータ |
...
- <span class="red-char">購入回数を評価値とみなして</span>評価データを用意 |
